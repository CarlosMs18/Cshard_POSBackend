...
namespace POS.Infrastructure.Persistences.Repositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : /*class*/ BaseEntity
    {
        ...
        {
            var getAll = await _entity.Where
                (x => x.State.Equals((int)StateTypes.Active) && x.AuditDeleteUser == null && x.AuditDeleteDate == null)
        ...
        public async Task<bool> EditAsync(T entity)
        {
            ...
            _context.Entry(entity).Property(x => x.AuditCreateUser).IsModified = false; //le decimos que no quremos que nos actuialize los campos de auditorio de creacion
        ...
        public async Task<bool> RemoveAsync(int id)
        {
            ...
            _context.Update(entity);//como es una eliminacion logica
